...
<body>
    ...
    <main class="container">
        ...
        <div class="btn-group countryButtons" role="group" aria-label="...">
              ...
              $div1="";
              for($x=0;$x<6;$x++){
                  $div1.="<a href='list.php?country=$countries[$x]' role='button' class='btn btn-default'> $countries[$x]</a>";
              }
		...
		<ul class="caption-style-2">
          ...
          for($y=0;$y<16;$y++){
              ...
              $div2.="<li>";
              $div2.="<a href='detail.php?id=$y' class='img-responsive'>";
              $div2.="<img src='images/square/".$images[$y]['path']."'/>";
              $div2.="<div class='caption'>";
              $div2.="<div class='blur'>";
              $div2.="</div>";
              $div2.="<div class='caption-text'>";
              $div2.="<h1>";
              $div2.=$images[$y]['title'];
              $div2.="</h1>";
              $div2.="</div>";
